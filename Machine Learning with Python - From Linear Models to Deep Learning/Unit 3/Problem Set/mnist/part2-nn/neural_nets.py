...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        relu_derivative_vectorize = np.vectorize(rectified_linear_unit_derivative)
        
        output_layer_error = np.asscalar((y - activated_output) * output_layer_activation_derivative(output))
        hidden_layer_error = output_layer_error * np.multiply(self.hidden_to_output_weights.T, relu_derivative_vectorize(hidden_layer_weighted_input)) # 3 by 1 matrix
